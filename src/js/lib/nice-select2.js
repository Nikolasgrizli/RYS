...
export default function NiceSelect(element, options) {
	...
	this.placeholder =
		attr(this.el, "placeholder") || this.config.placeholder || "Обрати";
	this.searchtext =
		attr(this.el, "searchtext") || this.config.searchtext || "Пошук";
	this.selectedtext =
		attr(this.el, "selectedtext") || this.config.selectedtext || "обрано";

	this.renderButtons =
		attr(this.el, "withBtn") || this.config.withBtn || false;
...
NiceSelect.prototype._renderSelectedItems = function () {
	if (this.multiple) {
		...
		if (
			...
			selectedHtml =
				this.selectedOptions.length + " " + this.selectedtext;
		}
...
NiceSelect.prototype._renderItem = function (option) {
	...
	if (option.attributes.optgroup) {
		...
		el.addEventListener("click", (optgroup) => {
			...
			while (
				next &&
				!next.classList.contains("optgroup") &&
				next.classList.contains("custom-select_children")
			) {
				next.click();
...
NiceSelect.prototype.bindEvent = function () {
	...
	this.dropdown.addEventListener(
		"focusin",
		triggerFocusIn.bind(this, this.el)
	);
	this.dropdown.addEventListener(
		"focusout",
